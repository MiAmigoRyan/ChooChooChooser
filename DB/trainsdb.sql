...
START TRANSACTION;
USE `trainsdb`;
INSERT INTO `train_ride` (`id`, `title`, `ride_date`, `rating`, `content`, `create_date`, `last_update`, `user_id`, `train_id`, `enabled`) VALUES (1, 'Risking it all at Devil\'s Gate', '2019-10-24', 5, NULL, NULL, NULL, 1, 1, 1);
INSERT INTO `train_ride` (`id`, `title`, `ride_date`, `rating`, `content`, `create_date`, `last_update`, `user_id`, `train_id`, `enabled`) VALUES (2, 'Breathtaking views at Devils Tail Stop', '2020-06-15', 5, NULL, NULL, NULL, 1, 3, 1);
