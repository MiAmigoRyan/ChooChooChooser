...
INSERT INTO `route` (`id`, `description`, `photo`, `start_station_id`, `end_station_id`, `train_id`, `region_id`) VALUES (4, 'Leadville Loop', 'https://www.google.com/maps/d/thumbnail?mid=15ff4vGIAHVQn8yKDcV7dGF31uls&hl=en_US', 3, 3, 2, 1);
...
INSERT INTO `route` (`id`, `description`, `photo`, `start_station_id`, `end_station_id`, `train_id`, `region_id`) VALUES (8, 'Antonito to Chama', 'https://cumbrestoltec.com/images/imap/imap_bg.png', 5, 6, 4, 1);
INSERT INTO `route` (`id`, `description`, `photo`, `start_station_id`, `end_station_id`, `train_id`, `region_id`) VALUES (9, 'Chama to Antonito', 'https://cumbrestoltec.com/images/imap/imap_bg.png', 6, 5, 4, 1);
...
INSERT INTO `route` (`id`, `description`, `photo`, `start_station_id`, `end_station_id`, `train_id`, `region_id`) VALUES (11, 'Tuckasegee River Excursion', 'https://hawkinsrails.net/preservation/gsm/tuckasegee/route_dillsboro.jpg', 7, 7, 5, 2);
